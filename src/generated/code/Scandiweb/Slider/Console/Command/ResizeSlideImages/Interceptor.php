<?php
namespace Scandiweb\Slider\Console\Command\ResizeSlideImages;

/**
 * Interceptor class for @see \Scandiweb\Slider\Console\Command\ResizeSlideImages
 */
class Interceptor extends \Scandiweb\Slider\Console\Command\ResizeSlideImages implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Scandiweb\Slider\Model\ResourceModel\Slide\Collection $slideCollection, \Scandiweb\Slider\Model\Slide $slideModel, \Magento\Framework\Filesystem $filesystem)
    {
        $this->___init();
        parent::__construct($slideCollection, $slideModel, $filesystem);
    }
